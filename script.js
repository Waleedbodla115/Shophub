...
const PERSONALIZED_API = `${API_BASE_URL}/api/ai/personalized`;
...
function setupThemeToggle() {
    ...
    if (!themeToggle) {
        console.warn("⚠️ ShopHub: #themeToggle not found.");
        return;
    }
...
function createRecommendedCard(product) {
    ...
    const imageUrl = window.getProductImageUrl
        ? window.getProductImageUrl(product.image)
        : "";
