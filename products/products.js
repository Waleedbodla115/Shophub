...
function getProductImageUrl(imagePath) {
    ...
    const imagePathWithPrefix = normalized.startsWith("/")
        ? normalized
        : `/images/${normalized}`;
    ...
    if (!allProducts.length) {
        grid.innerHTML = `
            <p class="text-center text-muted">
                ...
                Please start the backend and seed the database.
            </p>
        `;
        return;
    }
                ...
                <article class="col-6 col-md-4 col-lg-3">
                    <div class="card h-100 product-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            <span class="text-muted text-capitalize small">
...
/*
window.allProducts is defined as a live getter
because allProducts is reassigned inside
loadAllProducts() once the fetch resolves.
*/
